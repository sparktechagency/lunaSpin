...
import 'package:luna_spain/features/setting/presentation/controller/close_account_controller.dart';
...
class CloseAccountScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CloseAccountController>(builder: (c) {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Subtitle
                        CommonText(
                          text: AppString.closeAccountSubtitle,
                          fontSize: 16,
                          fontWeight: FontWeight.w600,
