...
import 'package:luna_spain/features/profile/presentation/controller/followers_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                        ...
                        Obx(
                          () => ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              final u = controller.followers[index];
                              return Padding(
      ...
      bottomNavigationBar: Container(
        ...
        child: SafeArea(top: false, child: const CommonBottomNavBar(currentIndex: 3)),
      ),
    );
  }
}
...
class _FollowTogglePill extends StatelessWidget {
  final bool isFollowing;
  final VoidCallback onTap;
  const _FollowTogglePill({required this.isFollowing, required this.onTap});

  @override
  Widget build(BuildContext context) {
    final bool showFollow = !isFollowing;
    return GestureDetector(
      onTap: onTap,
      child: Container(
        padding: EdgeInsets.symmetric(horizontal: 14.w, vertical: 7.h),
        decoration: BoxDecoration(
          color: showFollow ? AppColors.colorPrimaryGreen : AppColors.colourGreyScaleGreyTint40,
          borderRadius: BorderRadius.circular(16.r),
        ),
        child: CommonText(
          text: showFollow ? 'Follow' : 'Unfollow',
          fontSize: 12,
          fontWeight: FontWeight.w600,
          color: showFollow ? AppColors.colorPrimaryBlack : AppColors.colorNoticeError,
        ),
      ),
    );
  }
