...
import 'package:luna_spain/features/another_screen/club_management/presentation/controller/club_notification_settings_controller.dart';
import 'package:luna_spain/utils/constants/app_colors.dart';
import 'package:luna_spain/utils/constants/app_images.dart';
import 'package:luna_spain/utils/constants/app_string.dart';
import 'package:luna_spain/utils/extensions/extension.dart';

class ClubNotificationSettingScreen extends StatelessWidget {
  const ClubNotificationSettingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<ClubNotificationSettingsController>()) {
      Get.put(ClubNotificationSettingsController());
    }
    return Scaffold(
      ...
      body: GetBuilder<ClubNotificationSettingsController>(builder: (c) {
        return Column(
          children: [
            _TopBar(),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CommonText(
                            text: "Club Notification Settings",
                            fontSize: 28,
