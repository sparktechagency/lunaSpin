...
import 'package:luna_spain/features/another_screen/club_management/presentation/controller/club_privacy_controller.dart';
import 'package:luna_spain/utils/constants/app_colors.dart';
import 'package:luna_spain/utils/constants/app_images.dart';
import 'package:luna_spain/utils/constants/app_string.dart';
import 'package:luna_spain/utils/extensions/extension.dart';

class ClubPrivacyScreen extends StatelessWidget {
  const ClubPrivacyScreen({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<ClubPrivacyController>()) {
      Get.put(ClubPrivacyController());
    }
    ...
    return Scaffold(
      ...
      body: GetBuilder<ClubPrivacyController>(builder: (c) {
        return Column(
          children: [
            _TopBar(),
            Expanded(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Get.toNamed(AppRoutes.closeClub);
                            },
                            child: CommonText(
