...
import 'package:luna_spain/features/another_screen/booking_settings_screen/presentation/controller/waiting_list_setting_controller.dart';
import 'package:luna_spain/utils/constants/app_colors.dart';
import 'package:luna_spain/utils/constants/app_images.dart';
import 'package:luna_spain/utils/extensions/extension.dart';

class WaitingListSettingScreen extends StatelessWidget {
  const WaitingListSettingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<WaitingListSettingController>()) {
      Get.put(WaitingListSettingController());
    }
    return Scaffold(
      ...
      body: GetBuilder<WaitingListSettingController>(builder: (c) {
        return Column(
          children: [
            const _TopBar(),
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      _headerWithBadge('Waiting List Settings'),
                      12.height,
                      const CommonText(
                        textAlign: TextAlign.start,
                        text:
                            "Waiting lists enable users a chance to attend a class even when they become fully booked. Users can join a waiting list, and if a space becomes available they will be notified.",
                        fontSize: 16,
